...
public class quiz5Fragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ans = (RadioButton)getView().findViewById(R.id.question5);
        submit = (Button)getView().findViewById(R.id.submitans5);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(ans.isChecked())
                {
                    editor.putInt("ans5",1);
                }
                else {
                    editor.putInt("ans5", 0);
                }
                editor.apply();
                ((QuizActivity)getActivity()).setCurrentItem(5,true);
            }
        });
    }
